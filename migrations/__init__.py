...
def registerMigrations():
    ...
    MigrationTool.registerUpgradePath('3.0-alpha2',
                                      '3.0-beta1',
                                      v3_0.alphas.alpha2_beta1)

    MigrationTool.registerUpgradePath('3.0-beta1',
                                      '3.0-beta2',
                                      v3_0.betas.beta1_beta2)

    MigrationTool.registerUpgradePath('3.0-beta2',
                                      '3.0-beta3',
                                      v3_0.betas.beta2_beta3)

    MigrationTool.registerUpgradePath('3.0-beta3',
                                      '3.0-beta4 (SVN/UNRELEASED)',
                                      v3_0.betas.beta3_beta4)
