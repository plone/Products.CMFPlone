...
default_configlets = (
    ...
    {'id':'UsersGroups',
     'appId':'UsersGroups',
     'name':_('Users and Groups Administration'),
...
#     'imageUrl':'site_icon.gif'},
    ...
    {'id':'ZMI',
     'appId':'ZMI',
     'name':_('Zope Management Interface'),
