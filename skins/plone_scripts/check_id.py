...
plone_utils = getToolByInterfaceName('Products.CMFPlone.interfaces.IPloneTool', None)
...
portal_catalog = getToolByInterfaceName('Products.CMFCore.interfaces.ICatalogTool', None)
...
if checkForCollision:
    ...
    portal_types = getToolByInterfaceName('Products.CMFCore.interfaces.ITypesTool', None)
