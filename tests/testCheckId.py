...
class TestIsIDAutoGenerated(PloneTestCase.PloneTestCase):
    ...
    def testAutoGeneratedIdWithUnderScores(self):
        self.portal.portal_types.test_type=self.portal.portal_types.Event
        self.portal.portal_types.test_type.id="test_type"

        r = self.portal.plone_utils.isIDAutoGenerated('test_type.2004-11-09.0123456789')

        del self.portal.portal_types.test_type
