...
def registerMigrations():
    ...
    registerUpgradePath('2.5.3-final', '2.5.4-final', v2_5.two53_two54.two53_two54)
    registerUpgradePath('2.5.4-final', '2.5.4-2', null)

    # Plone 3.0

    registerUpgradePath('2.5.4-final', '3.0-alpha1', v3_0.alphas.three0_alpha1)
    ...
    registerUpgradePath('3.0.3', '3.0.4 (svn/unreleased)', v3_0.final_three0x.three03_three04)

    # Plone 3.5

    registerUpgradePath('3.0.4 (svn/unreleased)', '4.0 (svn/unreleased)', null)
