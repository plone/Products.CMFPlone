...
}),a(document).ready(function(){function b(b){var c=a("#form-widgets-retina_scales option:selected").attr("value"),d=a('div[data-fieldname="form.widgets.quality_2x"]'),e=a('div[data-fieldname="form.widgets.quality_3x"]');"disabled"==c?(d.fadeOut(),e.fadeOut()):"2x"==c?(d.fadeIn(),e.fadeOut()):"3x"==c&&(d.fadeIn(),e.fadeIn())}if(a("#ImagingSettings")){a('div[data-fieldname="form.widgets.quality_2x"]').hide(),a('div[data-fieldname="form.widgets.quality_3x"]').hide(),b();var c=a("#form-widgets-retina_scales");c.change(b)}})}),define("/trabajo/plone/buildout.coredev/src/Products.CMFPlone/Products/CMFPlone/static/plone.js",function(){});
