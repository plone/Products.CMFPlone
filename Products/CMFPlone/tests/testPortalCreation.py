...
class TestPortalCreation(PloneTestCase.PloneTestCase, WarningInterceptor):
    ...
    def testPloneSkins(self):
        ...
        self.assertTrue(hasattr(self.folder, 'plone_powered.gif'))
    ...
    def testFullScreenAction(self):
        ...
        self.assertTrue(self.actions.getActionInfo('document_actions/full_screen') is not None)
    ...
    def testVisibleIdsProperties(self):
        ...
        self.assertTrue(self.properties.site_properties.hasProperty('visible_ids'))
    ...
    def testUnfriendlyTypesProperty(self):
        ...
        self.assertTrue(self.properties.site_properties.hasProperty('types_not_searched'))
    ...
    def testNonDefaultPageTypes(self):
        ...
        self.assertTrue(self.properties.site_properties.hasProperty('default_page_types'))
    ...
    def testDisableFolderSectionsSiteProperty(self):
        ...
        props = self.portal.portal_properties.site_properties
        self.assertTrue(props.getProperty('disable_folder_sections', None) is not None)
    ...
    def testTypesUseViewActionInListingsProperty(self):
        ...
        self.assertTrue(self.properties.site_properties.hasProperty('typesUseViewActionInListings'))
    ...
    def testEnableLivesearchProperty(self):
        ...
        self.assertTrue(self.properties.site_properties.hasProperty('enable_livesearch'))

    def testRedirectLinksProperty(self):
        self.assertTrue(self.properties.site_properties.hasProperty('redirect_links'))
    ...
    def testTTWLockableProperty(self):
        self.assertTrue(self.properties.site_properties.hasProperty('lock_on_ttw_edit'))
    ...
    def testSyndicationEnabledOnNewsAndEvents(self):
        ...
        self.assertTrue(syn.isSyndicationAllowed(self.portal.events.aggregator))
    ...
    def testFolderHasSummaryView(self):
        ...
        self.assertTrue('folder_summary_view' in self.types.Folder.view_methods)

    def testFolderHasTabularView(self):
        # Folder type should allow 'folder_tabular_view'
        self.assertTrue('folder_tabular_view' in self.types.Folder.view_methods)
