...
class TestRecycleBin(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.annotations_mock.__getitem__ = lambda _, key: self.annotations.get(key, None)
        self.annotations_mock.__setitem__ = lambda _, key, value: self.annotations.__setitem__(key, value)
    ...
    def test_restore_item(self, IAnnotations_mock):
        ...
        target_container.__getitem__ = lambda _, key: test_obj if key == 'doc1' else None
    ...
    def test_purge_expired_items(self, datetime_mock, getUtility_mock, IAnnotations_mock):
