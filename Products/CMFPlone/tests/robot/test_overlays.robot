...
overlay should close
    Wait until keyword succeeds  5  5  Element Should Not Be Visible  id=exposeMask
    Wait until keyword succeeds  5  5  Page should not contain element  css=div.overlay
