...
class TestContentTypeScripts(PloneTestCase.PloneTestCase):
    ...
    def testEventCreate(self):
        ...
        self.assertTrue(self.folder.event.start().ISO8601().startswith('2003-09-18T00:00:00'))
        self.assertTrue(self.folder.event.end().ISO8601().startswith('2003-09-19T00:00:00'))
