...
class HiddenProfiles(object):
    ...
    def getNonInstallableProfiles(self):
        return [_DEFAULT_PROFILE,
                ...
                u'plone.app.cmsui:default',
                u'plone.app.collection:default',
                u'plone.app.discussion:default',
                u'plone.app.deco:default',
                u'plone.app.dexterity:default',
                u'profile-plone.app.deco:default',
                u'plone.app.folder:default',
                u'plone.app.imaging:default',
                u'plone.app.mediarepository:default',
                u'plone.app.page:default',
                u'plone.app.search:default',
                u'plone.app.standardtiles:default',
