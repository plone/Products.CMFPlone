...
class MemberDataTool(PloneBaseTool, BaseTool):
    ...
    # This method is the same as CMFCore.MemberDataTool's. But don't comment it
    # since the context is different. In the method, MemberData means Plone's 
    # MemberData but not CMFCore's. Or, Plone will always create CMFCore's
    # MemberData.
