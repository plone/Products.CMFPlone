...
class ISecuritySchema(Interface):
    ...
    enable_self_reg = Bool(title=_(u'Enable self-registration'),
                        description=_(u'''Allows users to register themselves on the site. 
                                       If not selected, only site managers can add new users.'''),
                        default=False,
                        required=False)

    enable_user_pwd_choice = Bool(title=_(u'Let users select their own passwords'),
                        description=_(u'''If not selected, passwords will be 
                                       autogenerated and mailed to users, which
                                       verifies that they have entered a valid email 
                                       address.'''),
                        default=False,
                        required=False)

    enable_user_folders = Bool(title=_(u'Enable User Folders'),
                        description=_(u'''If selected, empty home folders will be 
    ...
    allow_anon_views_about = Bool(title=_(u'Allow anyone to view "about" information'),
                        description=_(u'''If not selected only logged-in users 
                                       will be able to view information about who created
                                       an item and when it was modified.'''),
                        default=False,
                        required=False)
